                        ...
                        <div class="row">
                                ...
                                <a href="carDetailPage/1">
                                    <div class="work parallax">
                                        <div class="parallax-image" style="background-image: url('images/banner.jpg');">
                                            <div class="work_text" style="background-image: url('images/banner.jpg'); background-position:center; background-size:cover; background-blend-mode: multiply;">>
                            ...
                            <div class="col-md-6 margin_bottom">
                                <a href="carDetailPage/5">
                                    <div class="work parallax">
                                        <div class="parallax-image" style="background-image: url('images/banner.jpg');">
                                            <div class="work_text" style="background-image: url('https://cdn.motor1.com/images/mgl/mLQPr/s1/first-generation-acura-nsx.jpg'); background-position:center; background-size:cover; background-blend-mode: multiply;">
                        ...
                        <div class="row image-row-gap">
                            ...
                            <div class="col-md-6 margin_bottom">
                                <a href="carDetailPage/13">
                                    <div class="work parallax">
                                        <div class="parallax-image" style="background-image: url('images/banner.jpg');">
                                            <div class="work_text" style="background-image: url('https://musclecar.uk/wp-content/uploads/2020/09/MUSCLE-CAR-UK-1969-FORD-MUSTANG-BOSS429-FASTBACK-800x500-1.jpg'); background-position:center; background-size:cover; background-blend-mode: multiply;">
                            ...
                            <div class="col-md-6 margin_bottom">
                                <a href="carDetailPage/9">
                                    <div class="work parallax">
                                        <div class="parallax-image" style="background-image: url('images/banner.jpg');">
                                            <div class="work_text" style="background-image: url('https://hips.hearstapps.com/hmg-prod/images/1991-ferrari-f40-103-1593201414.jpg'); background-position:center; background-size:cover; background-blend-mode: multiply;">
